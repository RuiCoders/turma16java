...
insert tb_pizza (sabor, preco, tamanho, categoria_id) values ("MagoVegan",19.90,"Grande",5);
...
select tb_pizza.sabor from tb_pizza inner join tb_categoria on tb_categoria.id = tb_pizza.categoria_id where tb_categoria.tipo = "Doce"